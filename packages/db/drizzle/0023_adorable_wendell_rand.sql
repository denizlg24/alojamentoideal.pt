...
ALTER TABLE "conversations" ADD CONSTRAINT "conversations_provider_booking_order_fk" FOREIGN KEY ("provider_booking_id","order_id") REFERENCES "public"."provider_bookings"("id","order_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "messages" ADD CONSTRAINT "messages_sender_member_order_fk" FOREIGN KEY ("sender_member_id","order_id") REFERENCES "public"."order_members"("id","order_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
