...
export interface ApiRouteOptions {
	/**
	 * Emit per-request analytics events. Defaults to `true`. Errors are always
	 * captured regardless.
	 */
	analytics?: boolean;
 ...
 * (Postgres observability events) and per-request analytics. Mirrors the web
 * app's wrapper minus Sentry, which this app does not initialize.
 */
