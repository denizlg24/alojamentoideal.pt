    ...
    <Container class="max-w-[600px] mx-auto px-6 py-10 sm:px-4">
      ...
      <Section class="bg-[#fffdf9] px-9 pt-11 pb-9 rounded-t-[20px] sm:px-6">
        ...
        <Text class="m-0 text-[16px] leading-7 text-[#6a5d52]">
          We have received your payment for <Raw>__ACCOMMODATION_TITLE__</Raw>. Our team is finishing the last confirmation step and will email you as soon as your stay is secured.
        </Text>
